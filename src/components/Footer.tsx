        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              <div className="bg-white/40 p-1.5 rounded-md backdrop-blur-sm">
                <Image 
              ...
              <h2 className="text-3xl font-bold bg-gradient-to-r from-white via-blue-200 to-blue-300 bg-clip-text text-transparent [text-shadow:_0_0_15px_rgba(96,165,250,0.7)] transition-all duration-500 hover:from-white hover:to-blue-200 hover:scale-105">
                LUMINATE
              </h2>
            </div>
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              {[
                ...
                >
                  <svg className="w-5 h-5" viewBox="0 0 24 24" fill={social.color}>
                    <path d={social.icon} />
                  </svg>
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['Home', 'About Us', 'Courses', 'Blog', 'Gallery', 'Contact'].map((item) => (
                <li key={item}>
                  <Link 
